...
Web 工作台支持词牌搜索、逐字格律预览、多韵组设置、优化轮数、附加要求，以及
《词林正韵》十九部和 Unihan 单字读音查询。
...
- 已导入《御定词谱》36 个常用词牌正体、《词林正韵》十九部和 Unicode 17.0
  Unihan 读音数据；来源、修订和许可见 `THIRD_PARTY_DATA.md`。
- 词谱保留了 245 个历史体候选，目前运行时仅启用每个词牌的正体。生成状态为
  `imported`，表示通过机器回查，但仍需文史专家逐条校勘后升级为 `verified`。

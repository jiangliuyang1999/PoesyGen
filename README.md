...
Web 地址为 `http://localhost:5173`。页面无需 LLM 配置即可浏览全部 36 个词牌、245
...
- 已导入《御定词谱》36 个常用词牌的 245 种体式、《词林正韵》十九部和 Unicode
  17.0 Unihan 读音数据；其中 231 体通过例词、字数、句式和韵位回查，其余 14 体以
  `draft` 状态保留并记录待校问题。来源、修订和许可见 `THIRD_PARTY_DATA.md`。
